...
namespace nexly::runtime
{
    ...
    public:
        ...
        {
            return nexly::common::getDTypeSize(static_cast<nvinfer1::DataType>(*this));
        }
    ...
    template <typename T>
    class BufferRange : public nexly::common::ArrayView<T>
    {
    public:
        using Base = nexly::common::ArrayView<T>;
