...
#define TENSOR_GETTER_SETTER(funcName, tensorName)                                                                     \
    ...
    {                                                                                                                  \
        if constexpr (std::is_same_v<TensorPtr, nexly::runtime::ITensor::SharedPtr>)                            \
        {                                                                                                              \
...
class InferenceRequest : public GenericInferenceRequest<nexly::runtime::ITensor::SharedPtr, NamedTensor>
{
public:
    using Base = GenericInferenceRequest<nexly::runtime::ITensor::SharedPtr, NamedTensor>;
